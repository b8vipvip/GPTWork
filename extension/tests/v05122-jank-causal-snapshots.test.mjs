...
test('v0.5.122 content-off has one lifecycle authority while the diagnostic control plane stays alive', () => {
...
test('v0.5.122 keeps a constant out-of-band Long Task observer across content-off phases', () => {
...
test('v0.5.122 snapshots the completed phase before changing isolation state', () => {
...
test('v0.5.122 collector and analyzer preserve causal phase page evidence in the small upload bundle', () => {
...
test('v0.5.122 retains the verified request and served-model lineage fixes from v0.5.120-v0.5.121', () => {
